...
class Servidor(QThread):
    ...
    def run(self):
        try:
            ...
            self.anfitrion = self.get_ip_address()
    ...
    # Método para obtener la dirección IP del anfitrión
    def get_ip_address(self):
        hostname = socket.gethostname()  # Obtiene el nombre del anfitrión
        ip_address = socket.gethostbyname(hostname)  # Obtiene la dirección IP correspondiente al nombre del anfitrión
        print(hostname)
        return ip_address
